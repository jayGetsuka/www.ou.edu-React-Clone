                            ...
                            >
                                ...
                                <div className="py-1">
                                    ...
                                    {({ active }) => (
                                        ...
                                        className={classNames(
                                            active ? 'bg-none text-orange-50' : 'text-orange-50 bg-none',
                                            'block px-4 py-2 text-right text-xs mr-2'
                                        )}
                                        >
                                        FOR YOU
                                        </a>
                                ...
                                <div className="py-1 mx-6">
                                    ...
                                    {({ active }) => (
                                        ...
                                        href="#"
                                        className={classNames(
                                            active ? 'bg-red-700 text-orange-50' : 'text-orange-50',
                                            'block px-2 py-1 text-[12px] font-bold text-right'
                                        )}
                                        >
                                        ALUMNI
                                        </a>
                                    ...
                                    {({ active }) => (
                                        ...
                                        className={classNames(
                                            active ? 'bg-none text-orange-50' : 'text-orange-50 bg-none',
                                            'block px-4 py-2 text-right text-xs mr-[-15px] mt-[10px]'
                                        )}
                                        >
                                        EXPLORE OU
                                        </a>
                                ...
                                <div className="py-1 mx-6">
                                    ...
                                    {({ active }) => (
                                        ...
                                        className={(
                                            active ? 'bg-red-700 text-orange-50' : 'text-orange-50',
                                            'block px-2 py-1 text-[13px] font-bold text-right text-orange-50'
                                        )}
                                        >
                                        ATHLETICS
                                        </a>
                                    ...
                                    {({ active }) => (
                                        ...
                                        className={classNames(
                                            active ? 'bg-red-700 text-orange-50' : 'text-orange-50',
                                            'block px-2 py-1 text-[12px] font-bold text-right mb-2'
                                        )}
                                        >
                                        CONTACT OU
                                        </a>
